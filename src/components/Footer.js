        ...
        <div class="flex flex-wrap md:text-left text-center order-first">
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                ...
                <a class="text-gray-400 hover:text-white">8709802512</a>
              </li>
              <li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                <a class="text-gray-400 hover:text-white">Careeres</a>
              </li>
              <li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a class="text-gray-400 hover:text-white">Payments</a>
              </li>
              <li>
                <a class="text-gray-400 hover:text-white">Shipping</a>
              </li>
              <li>
                <a class="text-gray-400 hover:text-white">
            ...
            <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                ...
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  class="w-full bg-gray rounded border bg-opacity-40 border-gray-700  focus:ring-2 focus:ring-blue-900 focus:border-blue-500 text-base outline-none text-gray-800 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
              <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-cyan-950 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 hover:text-gray-100 font-bold rounded">
                Register
              </button>
            </div>
      ...
      <div class="bg-gray-800 bg-opacity-75">
        <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
            ...
            <span class="ml-3 text-xl">Assignment</span>
          </a>
